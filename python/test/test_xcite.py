...
class TestXciteParserp(unittest2.TestCase):
    ...
    def test_parse_1(self):
        [first_cluster, second_cluster] = CiteParser().parse("@item1")
    ...
    def test_parse_3(self):
        [first_cluster, second_cluster] = CiteParser().parse("@item1 [p. 30, with suffix]")
        self.assertEqual(first_cluster,
                         [CitationInfo(key="item1", author_only=True)])
        self.assertEqual(second_cluster,
    ...
    def test_parse_4(self):
        [first_cluster, second_cluster] = CiteParser().parse("@item1 [-@item2 p. 30; see also @item3]")
        self.assertEqual(first_cluster,
                         [CitationInfo(key="item1", author_only=True)])
        self.assertEqual(second_cluster,
                         [CitationInfo(key="item1",
    ...
    def test_parse_5(self):
        [first_cluster, second_cluster] = CiteParser().parse("[see @item1 p. 34-35; also @item3 chap. 3]")
    ...
    def test_parse_6(self):
        [first_cluster, second_cluster] = CiteParser().parse("[see @item1 p. 34-35]")
        self.assertEqual(first_cluster, None)
        self.assertEqual(second_cluster,
                         [CitationInfo(key="item1",
                                       prefix="see",
    ...
    def test_parse_7(self):
        [first_cluster, second_cluster] = CiteParser().parse("[@item1 pp. 33, 35-37 and nowhere else]")
        self.assertEqual(first_cluster, None)
        self.assertEqual(second_cluster,
                         [CitationInfo(key="item1",
                                       locator="pp. 33, 35-37",
    ...
    def test_parse_8(self):
        [first_cluster, second_cluster] = CiteParser().parse("[@item1 and nowhere else]")
        self.assertEqual(first_cluster, None)
        self.assertEqual(second_cluster,
                         [CitationInfo(key="item1",
                                       suffix="and nowhere else")])
    ...
    def test_parse_10(self):
        [first_cluster, second_cluster] = CiteParser().parse("[@item3]")
        self.assertEqual(first_cluster, None)
        self.assertEqual(second_cluster,
                         [CitationInfo(key="item3")])
    ...
    def test_parse_11(self):
        [first_cluster, second_cluster] = CiteParser().parse("[see @item2 chap. 3; @item3; @item1]")
        self.assertEqual(first_cluster, None)
        self.assertEqual(second_cluster,
                         [CitationInfo(key="item2",
                                       prefix="see",
    ...
    def test_parse_13(self):
        [first_cluster, second_cluster] = CiteParser().parse("[-@item2 p. 44]")
        self.assertEqual(first_cluster, None)
        self.assertEqual(second_cluster,
                         [CitationInfo(key="item2",
                                       suppress_author=True,
